...
- `QString autoNaming(const QString &filePath)`: given the file path 
...
- `QFileInfo autoNaming(const QFileInfo &fileInfo)`: starting from
...
- `QStringList readAsStringList(const QString &absoluteFilePath)`: reads
