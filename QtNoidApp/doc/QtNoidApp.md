...
- [**ConfigGlobal**](doc/ConfigGlobal.md): this is a singleton class that create a unique instance of ConfigFile, available as **appConfig** that can be used to save and restore application configuration.
