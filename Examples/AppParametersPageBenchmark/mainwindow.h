...
private slots:
    ...
    void on_cmdGOParametersPageFromJson_clicked();
...
private:
    ...
    std::pair<quint64, quint64> benchmarkParametersPageUsingJSON(int paramtersCount);
    std::pair<quint64, quint64> benchmarkParameterListToJSON(int paramtersCount);
